...
t_semaphore	*init_semaphore(t_parameters *param)
{
	...
	semaphore->sem_fork = sem_open("sem_fork", O_CREAT, 0664, \
								param->nbr_philosophers);
	semaphore->sem_times_to_eat = sem_open("sem_times_to_eat", O_CREAT, \
								0664, param->nbr_philosophers);
	semaphore->sem_last_meal = sem_open("sem_last_meal", O_CREAT, 0664, \
								param->nbr_philosophers);
