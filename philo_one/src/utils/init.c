...
t_mutex			*init_mutex(t_parameters *param)
{
	...
	mutex->arr_fork = ft_calloc(sizeof(pthread_mutex_t), param->nbr_philosophers);
	mutex->arr_times_to_eat = ft_calloc(sizeof(pthread_mutex_t), param->nbr_philosophers);
	mutex->arr_last_meal = ft_calloc(sizeof(pthread_mutex_t), param->nbr_philosophers);
